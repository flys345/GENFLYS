...
echo "/usr/bin/gerar.sh" > /usr/bin/genflys && chmod +x /usr/bin/genflys
echo -e "\033[1;33m Perfeito, Use o Comando \033[1;31mgerar.sh o gerar o genflys \033[1;33mpara Gerenciar as Suas Keys e
